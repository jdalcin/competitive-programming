 ...
 * Motivation: practice with strings
 * Class: various methods to use strings
 * Notes: split is a powerful methods, use clas "StringBuilder" to create strings of huge size, "append" is a method of class "StringBuilder", append is not just for one line of code but rather makes permanent changes to a String
 *---------------------------*
 */
